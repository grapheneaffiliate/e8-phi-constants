...
\emph{Note:} This is a numerical match, not an algebraic identity. Only $m_s/m_d = 20$ is exact.
\end{enumerate}

The first result ($m_s/m_d = 20$) is an exact algebraic identity. The second ($m_b/m_c = 2.854$) is a numerical match at 0.21\% accuracy.
